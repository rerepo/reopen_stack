...
#define	AES_MEM_MODE_MASK	0x1
#define	AES_CPU_MODE		0x0
#define	AES_DMA_MODE		0x1

#define	AES_PARAM_MODE_MASK	0x2
#define	AES_SG_PARAMS		0x0
#define	AES_VOID_PTR_PARAMS	0x2
     


#ifndef PRC_CALLBACK_T
typedef void (*prc_callback_t)(void);
#define PRC_CALLBACK_T
#endif
...
#endif
EXTERN void 	brcm_cbc_aes_encrypt_frag(u8 mem_mode,u8* key, int key_len,u8* iv, int iv_len,struct scatterlist *dst,struct scatterlist *src,unsigned int nbytes);
EXTERN void 	brcm_cbc_aes_decrypt_frag(u8 mem_mode,u8* key, int key_len,u8* iv, int iv_len,struct scatterlist *dst,struct scatterlist *src,unsigned int nbytes);
EXTERN void		brcm_cbc_aes_encrypt_no_frag(u8 mem_mode,u8* key, int key_len,u8* iv, int iv_len,void *dst, void *src,unsigned int nbytes);
EXTERN void		brcm_cbc_aes_decrypt_no_frag(u8 mem_mode,u8* key, int key_len,u8* iv, int iv_len,void *dst, void *src,unsigned int nbytes);
EXTERN void  	brcm_aead_aes_init_module (void);
//ZZZ#if 0
EXTERN void 	register_blk_cb(prc_callback_t cb);
EXTERN void 	register_hash_cb(prc_callback_t cb);
//ZZZ#endif
#undef EXTERN

#ifndef PERCELLO_SHA_H
#define PERCELLO_SHA_H
...
#ifdef __SHA_INTERNAL__
void __exit percello_SHA_cleanup_module (void);
#define EXTERN 
#else
...
EXTERN void brcm_sha1_decrypt_frag(u8 mem_mode,u8 *key,unsigned int key_len,unsigned int mlen, void *assoc,struct scatterlist *src, int nbytes);
EXTERN void brcm_sha1_encrypt_frag(u8 mem_mode,u8 *key,unsigned int key_len,unsigned int mlen, void *assoc,struct scatterlist *src, int nbytes);
EXTERN void brcm_sha1_decrypt_no_frag(u8 mem_mode,u8 *key,unsigned int key_len,unsigned int mlen, void *src, int nbytes);
EXTERN void brcm_sha1_encrypt_no_frag(u8 mem_mode,u8 *key,unsigned int key_len,unsigned int mlen, void *src, int nbytes);

EXTERN void  	brcm_aead_sha_init_module (void);

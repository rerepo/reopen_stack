...
static int brcm_sha1_init(struct shash_desc *desc);
static int brcm_sha1_update(struct shash_desc *desc, const u8 *data, unsigned int len);
static int brcm_sha1_final(struct shash_desc *desc, u8 *out);
#endif
